...
if (require.main === module) {
    ...
    if (!apiKey) {
        console.log('📖 用法: node api_key_validator.js YOUR_API_KEY');
        console.log('📖 示例: node api_key_validator.js AIzaSyBkEd8rJqHvKvXXXXXXXXXXXXXXXXXXXXX');
        console.log('');
